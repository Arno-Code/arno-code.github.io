---
title: SpringCloud系列-08之配置中心Config
author:
name: Leoz
link: https://gitee.com/Arno-Code
date: 2020-04-17 12:10:00 +0800
...
而Spring Cloud Config（百度的 Disconf 与之类似）便提供了适用于分布式系统的、集中式的外部化配置支持
...
关于配置仓库里面文件内容的加密，可考虑：[http://cloud.spring.io/spring-cloud-vault/](http://cloud.spring.io/spring-cloud-vault/)
